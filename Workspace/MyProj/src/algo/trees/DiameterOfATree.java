...
/*
		...
		DoublePointer<Integer> dia=new DoublePointer<Integer>(0);
	...
	//O(n) algorithm
	public static int modifiedHeight(TreeNode root, DoublePointer<Integer> dia) {
		if(root==null)
			return 0;
		...
		if(d>dia.getValue())dia.setValue(d);
