...
public class CapacitatedVehicleRoutingProblemWithTimeWindows {
   ...
   * @param timeWindowStartMax maximum starting time of the order time window.
  ...
  private void buildOrders(int numberOfOrders,
    ...
    for (int order = 0; order < numberOfOrders; ++order) {
      ...
      int timeWindowStart = randomGenerator.nextInt(timeWindowStartMax + 1);
   ...
   * @param xMax maximum x coordinate in which vehicles are located.
   * @param yMax maximum y coordinate in which vehicles are located.
 ...
 private void mybuildOrders() {
      locations.add(Pair.of(0,10));
      orderDemands.add(3);
      orderTimeWindows.add(Pair.of(60,90));
      orderPenalties.add(5);


      locations.add(Pair.of(10,0));
      orderDemands.add(3);
      orderTimeWindows.add(Pair.of(60,100));
      orderPenalties.add(5);


      locations.add(Pair.of(10,10));
      orderDemands.add(5);
      orderTimeWindows.add(Pair.of(60,70));
      orderPenalties.add(5);
    
  }

  private void mybuildFleet() {

      vehicleCapacity = 10;
      vehicleStarts = new int[2];
      vehicleEnds = new int[2];

      vehicleStarts[0] = locations.size();
      locations.add(Pair.of(0,0));
      vehicleEnds[0] = locations.size();
      locations.add(Pair.of(10,0));
      vehicleEndTime.add(120);
      vehicleCostCoefficients.add(2);

      vehicleStarts[1] = locations.size();
      locations.add(Pair.of(0,0));
      vehicleEnds[1] = locations.size();
      locations.add(Pair.of(10,10));
      vehicleEndTime.add(120);
      vehicleCostCoefficients.add(2);
  ...
  public static void main(String[] args) throws Exception {
    ...
    final int timeWindowStartMax = 24 * 60;
...
final int orders = 3;
    ...
    final int capacity = 50;
     ...
     /*problem.mybuildOrders();
      problem.mybuildFleet();
       problem.solve(3, 2);*/
